...
urlpatterns = [
    ...
    path('reset/', auth_views.PasswordResetView.as_view(
        template_name='register/password_reset.html', email_template_name='register/password_reset_email.html', subject_template_name='register/password_reset_subject.txt'), name='password_reset'),
